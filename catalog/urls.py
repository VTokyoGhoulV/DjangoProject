...
urlpatterns = [
    ...
    path("unpublish_product/<int:pk>/", catalog.ProductUnpublishView.as_view(), name="unpublish_product"),
    path("products_by_category/", catalog.ProductListView.as_view(), name="products_by_category"),
]
